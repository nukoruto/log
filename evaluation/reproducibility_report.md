# Reproducibility Report: Log Anomaly Detection Benchmark

This document records the metadata required for reproducing the experimental results of DeepLog and LogAnomaly on the HDFS dataset.
...
*   **Codebase**: 
    ...
    *   **Models**: `models/DeepLog`, `models/LogDeep`

### (B) Methodological Information (Methodological)

#### Model Architectures

| Parameter | DeepLog | LogAnomaly |
| :--- | :--- | :--- |
| **Model Type** | LSTM (Seq2Seq approach) | LSTM (Semantic + Quant + Seq) |
| **Input Size** | 1 (Index) | 1 (Seq) + 300 (Sem) + 1 (Quan) |
| **Hidden Size** | 64 | 64 |
| **Num Layers** | 2 | 2 |
| **Optimizer** | Adam | Adam |
...
*   **Semantic Vectors (LogAnomaly Only)**:
